...
// BlueprintGeneratedClass StatWrapper_Player_Victories.StatWrapper_Player_Victories_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_Victories_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62875);
		return ptr;
	}
