...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_ZXL5[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W3V9[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_CZ9V[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_QSP0[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_OAE0[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_ITB2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_WZ44[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_GKZU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventReply
{
	unsigned char                                      UnknownData_13DN[0xC0];                                    // 0x0000(0x00C0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_500K[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_P7SZ[0x3];                                     // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_NG11[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
{
	TArray<struct FName>                               BrushPropertyNamePath;                                     // 0x0080(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
	unsigned char                                      UnknownData_UWLB[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
