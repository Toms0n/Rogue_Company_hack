...
// BlueprintGeneratedClass StatWrapper_Rogue_Downs.StatWrapper_Rogue_Downs_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_Downs_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62865);
		return ptr;
	}
