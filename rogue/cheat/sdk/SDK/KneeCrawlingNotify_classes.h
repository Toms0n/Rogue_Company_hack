...
public:
	...
	unsigned char                                      UnknownData_UFIA[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(27328);
		return ptr;
	}
