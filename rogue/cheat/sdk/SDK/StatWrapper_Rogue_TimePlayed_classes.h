...
// BlueprintGeneratedClass StatWrapper_Rogue_TimePlayed.StatWrapper_Rogue_TimePlayed_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_TimePlayed_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62850);
		return ptr;
	}
