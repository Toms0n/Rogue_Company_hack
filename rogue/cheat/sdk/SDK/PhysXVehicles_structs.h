...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_OQW0[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_IHVY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_VEJ6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_O0FU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1R8Z[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_JNLS[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2OY1[0x18];                                    // 0x00D8(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CWMW[0x10];                                    // 0x06E0(0x0010) MISSED OFFSET (PADDING)
