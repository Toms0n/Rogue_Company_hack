...
{
public:
	unsigned char                                      UnknownData_6GYR[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QRH8[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2072);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_UPQJ[0x10];                                    // 0x00B0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1KF3[0x78];                                    // 0x0028(0x0078) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2075);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_QFEL[0x180];                                   // 0x00B0(0x0180) MISSED OFFSET (PADDING)
...
template<typename T>
	...
	{
		// return nullptr;
		return GetVFunction<UObject*(*)(UClass*)>(this, 66)(this);
	}
...
public:
	...
	unsigned char                                      pad_1DKE0HJQUA[0x01];                                      // 0x00B7(0x0001) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_W23TYX3LVS[0x02];                                      // 0x00BE(0x0002) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_FG7N8JEMMX[0x04];                                      // 0x00D4(0x0004) NOT AUTO-GENERATED PROPERTY
	void*                                              Func;                                                      // 0x00D8(0x0008) NOT AUTO-GENERATED PROPERTY


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2077);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_D6ED[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2079);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_3EMC[0x80];                                    // 0x0230(0x0080) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2080);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_CMVQ[0xB8];                                    // 0x0028(0x00B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2081);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_MWEG[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2082);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_RKGW[0x1B8];                                   // 0x0230(0x01B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2083);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_VXYH[0xC8];                                    // 0x0028(0x00C8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2084);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_961R[0x1B8];                                   // 0x00E0(0x01B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2085);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ZDBW[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2086);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_4EU2[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2087);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_8XXZ[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZWSW[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NGW3[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9FOJ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QLK6[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DWLF[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2094);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2095);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_AS9F[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JNHB[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2097);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2098);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2099);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2103);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_R20G[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XTIN[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_C8RT[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JJL8[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7P0E[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2GM5[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2119);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2120);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_EJL9[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2123);
		return ptr;
	}
