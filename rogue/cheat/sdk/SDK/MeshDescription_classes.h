...
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2503);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_THKQ[0x368];                                   // 0x0028(0x0368) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2504);
		return ptr;
	}
