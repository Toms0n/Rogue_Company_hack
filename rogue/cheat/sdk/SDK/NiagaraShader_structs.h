...
{
	unsigned char                                      UnknownData_Q95M[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraCompileEvent
{
	...
	unsigned char                                      UnknownData_VN45[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
