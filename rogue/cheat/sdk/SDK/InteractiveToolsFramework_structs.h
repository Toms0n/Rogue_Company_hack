...
{
	unsigned char                                      UnknownData_2XYC[0xA8];                                    // 0x0000(0x00A8) MISSED OFFSET (PADDING)
...
struct FBehaviorInfo
{
	...
	unsigned char                                      UnknownData_OBKE[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveGizmo
{
	unsigned char                                      UnknownData_XAMH[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FInputRayHit
{
	unsigned char                                      UnknownData_NQUK[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
