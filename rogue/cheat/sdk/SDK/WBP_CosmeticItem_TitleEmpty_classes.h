...
// WidgetBlueprintGeneratedClass WBP_CosmeticItem_TitleEmpty.WBP_CosmeticItem_TitleEmpty_C
// 0x0008 (FullSize[0x0520] - InheritedSize[0x0518])
class UWBP_CosmeticItem_TitleEmpty_C : public UKSWidget
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(59732);
		return ptr;
	}
