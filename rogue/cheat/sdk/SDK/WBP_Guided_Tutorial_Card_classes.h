...
public:
	...
	class URichTextBlock*                              DescriptionText;                                           // 0x0240(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UWBP_Header2_C*                              WBP_Header2;                                               // 0x0270(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(61472);
		return ptr;
	}



	void SetCardData(const struct FGuidedCalloutCardData& CardData);
	void PreConstruct(bool IsDesignTime);
	void ExecuteUbergraph_WBP_Guided_Tutorial_Card(int EntryPoint);
};
