...
public:
	...
	unsigned char                                      UnknownData_L6CB[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(714);
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_DJF8[0x3];                                     // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F1KN[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
