...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(675);
		return ptr;
	}
...
public:
	...
	TArray<int>                                        LodMap;                                                    // 0x00D8(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FName>                               UsedBoneNames;                                             // 0x00E8(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int>                                        UsedBoneIndices;                                           // 0x00F8(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_PEAZ[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0DEZ[0x4];                                     // 0x01EC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SQN6[0x20];                                    // 0x0168(0x0020) MISSED OFFSET (PADDING)
