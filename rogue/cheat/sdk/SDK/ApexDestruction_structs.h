...
struct FDestructibleDamageParameters
{
	...
	unsigned char                                      UnknownData_9ERY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_45YZ[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDestructibleSpecialHierarchyDepths
{
	...
	unsigned char                                      UnknownData_07WO[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDestructibleParametersFlag
{
	...
	unsigned char                                      UnknownData_RV5I[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FDestructibleParameters
{
	...
	unsigned char                                      UnknownData_MLJS[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FDestructibleDepthParameters>        DepthParameters;                                           // 0x0070(0x0010) (Edit, EditFixedSize, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDestructibleParametersFlag                 Flags;                                                     // 0x0080(0x0004) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YOWT[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
