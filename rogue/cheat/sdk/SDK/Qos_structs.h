...
struct FQosPingServerInfo
{
	...
	unsigned char                                      UnknownData_1QG2[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FQosDatacenterInfo
{
	...
	unsigned char                                      UnknownData_Y1CF[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatacenterQosInstance
{
	...
	unsigned char                                      UnknownData_LCGR[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<int>                                        PingResults;                                               // 0x0040(0x0010) (ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_693F[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W95G[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FQosRegionInfo
{
	...
	unsigned char                                      UnknownData_R5Y2[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
