...
struct FMovieSceneMediaPlayerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_E5L8[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMediaSectionParams
{
	...
	unsigned char                                      UnknownData_IV67[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
