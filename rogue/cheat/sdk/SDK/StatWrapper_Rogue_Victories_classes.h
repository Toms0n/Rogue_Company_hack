...
// BlueprintGeneratedClass StatWrapper_Rogue_Victories.StatWrapper_Rogue_Victories_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_Victories_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62848);
		return ptr;
	}
