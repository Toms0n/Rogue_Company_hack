...
// 0x0682 (FullSize[0x09E2] - InheritedSize[0x0360])
...
public:
	...
	bool                                               Is_Fully_Opened;                                           // 0x09E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                               Is_Fully_Closed;                                           // 0x09E1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(25982);
		return ptr;
	}
