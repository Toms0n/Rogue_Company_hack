...
class UWBP_GameModeInfoPanel_Lobby_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(87320);
		return ptr;
	}
	...
	void SetDisplayInfo(const struct FText& Title, const struct FText& Description, bool UseMapImage, const struct FMapDetail& MapInfo);
	void SetQueueInfo(const struct FClientQueueInfo& QueueInfo, bool UseMapImage, const struct FMapDetail& MapInfo);
	void ExecuteUbergraph_WBP_GameModeInfoPanel_Lobby(int EntryPoint);
};
