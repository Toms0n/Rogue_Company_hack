...
// BlueprintGeneratedClass StatWrapper_Player_WinPercentage.StatWrapper_Player_WinPercentage_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_WinPercentage_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62872);
		return ptr;
	}
