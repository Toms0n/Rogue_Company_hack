...
public:
	...
	unsigned char                                      UnknownData_W4P2[0x9C];                                    // 0x003C(0x009C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(683);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_Z2AM[0x390];                                   // 0x0028(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x03B8(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GWDX[0x8];                                     // 0x03C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F9VR[0x148];                                   // 0x03D4(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X1AG[0x1E4];                                   // 0x0524(0x01E4) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(685);
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_EHZ5[0xA4];                                    // 0x003C(0x00A4) MISSED OFFSET (PADDING)
