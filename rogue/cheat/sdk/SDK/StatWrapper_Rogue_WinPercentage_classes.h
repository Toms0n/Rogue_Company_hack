...
// BlueprintGeneratedClass StatWrapper_Rogue_WinPercentage.StatWrapper_Rogue_WinPercentage_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_WinPercentage_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62845);
		return ptr;
	}
