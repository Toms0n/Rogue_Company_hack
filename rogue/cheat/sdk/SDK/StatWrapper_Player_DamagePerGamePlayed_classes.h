...
// BlueprintGeneratedClass StatWrapper_Player_DamagePerGamePlayed.StatWrapper_Player_DamagePerGamePlayed_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_DamagePerGamePlayed_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62894);
		return ptr;
	}
