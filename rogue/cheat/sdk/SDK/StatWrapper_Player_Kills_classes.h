...
// BlueprintGeneratedClass StatWrapper_Player_Kills.StatWrapper_Player_Kills_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_Kills_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62885);
		return ptr;
	}
