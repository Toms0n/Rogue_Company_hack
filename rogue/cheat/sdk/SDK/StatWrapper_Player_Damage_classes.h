...
// BlueprintGeneratedClass StatWrapper_Player_Damage.StatWrapper_Player_Damage_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_Damage_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62897);
		return ptr;
	}
