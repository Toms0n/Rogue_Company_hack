...
{
	TArray<struct FString>                             Value;                                                     // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FMovieSceneCaptureSettings
{
	...
	unsigned char                                      UnknownData_LT3L[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T7IQ[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_06A7[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4ZTB[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SSYV[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
