...
struct FSubmixEffectDynamicProcessorFilterSettings
{
	...
	unsigned char                                      UnknownData_MYAY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubmixEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_XVDW[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S5AI[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PZBO[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FSubmixEffectEQBand
{
	...
	unsigned char                                      UnknownData_SWEC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubmixEffectReverbFastSettings
{
	...
	unsigned char                                      UnknownData_B871[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
