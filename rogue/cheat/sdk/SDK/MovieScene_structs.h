...
struct FMovieSceneEasingSettings
{
	...
	unsigned char                                      UnknownData_B8OC[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZRCH[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3EU5[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackEvalOptions
{
	...
	unsigned char                                      UnknownData_K8XF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MKOE[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LAK0[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HSYO[0x88];                                    // 0x0000(0x0088) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LJKI[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1QEO[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BA6U[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S2IY[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneTemplateGenerationLedger
{
	...
	unsigned char                                      UnknownData_XK5G[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequenceHierarchyNode
{
	...
	unsigned char                                      UnknownData_PFC6[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FMovieSceneTimeTransform                    LinearTransform;                                           // 0x0000(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_0E46[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSubSequenceData
{
	...
	unsigned char                                      UnknownData_RQN3[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      UnknownData_2SAB[0x5];                                     // 0x0013(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1QWU[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTemplate
{
	...
	unsigned char                                      UnknownData_0VWI[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GDUL[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequenceReplProperties
{
	...
	unsigned char                                      UnknownData_RB5X[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3HK3[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FMovieSceneSequenceID, class UObject*> DirectorInstances;                                         // 0x0018(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_7YJU[0x2B8];                                   // 0x0068(0x02B8) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequencePlaybackSettings
{
	...
	unsigned char                                      UnknownData_127K[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_01HV[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneSectionParameters
{
	...
	unsigned char                                      UnknownData_L75X[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarkedFrame
{
	...
	unsigned char                                      UnknownData_AIPU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	int                                                SequenceID;                                                // 0x0000(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	unsigned char                                      UnknownData_NW6C[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Guid;                                                      // 0x0008(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
struct FMovieSceneSpawnable
{
	...
	unsigned char                                      UnknownData_UINR[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X835[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O6KM[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W6PD[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneBindingOverrideData
{
	...
	unsigned char                                      UnknownData_72EJ[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K4PV[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase
{
	...
	unsigned char                                      UnknownData_J6F0[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WBE2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T3WG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneByteChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_9OJJ[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MF82[0x60];                                    // 0x0038(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
	...
	bool                                               bHasDefaultValue;                                          // 0x0019(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_C3RT[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<bool>                                       Values;                                                    // 0x0020(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_WPNI[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_QPZS[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        Values;                                                    // 0x0020(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_F4R9[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneTangentData
{
	...
	unsigned char                                      UnknownData_OPJU[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatValue
{
	...
	unsigned char                                      UnknownData_6RPU[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_77C7[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_973M[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_A3E3[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ED9V[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneSubSectionData
{
	...
	unsigned char                                      UnknownData_XOQK[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZBC6[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneKeyTimeStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_GP90[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K2YS[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_VZBV[0x60];                                    // 0x0060(0x0060) MISSED OFFSET (PADDING)
...
struct FSectionEvaluationData
{
	...
	unsigned char                                      UnknownData_612V[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackDisplayOptions
{
	...
	unsigned char                                      UnknownData_LOYW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
