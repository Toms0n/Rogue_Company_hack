...
// BlueprintGeneratedClass StatWrapper_Player_TimePlayed.StatWrapper_Player_TimePlayed_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_TimePlayed_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62877);
		return ptr;
	}
