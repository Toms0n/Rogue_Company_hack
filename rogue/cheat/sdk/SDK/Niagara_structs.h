...
struct FNiagaraTypeDefinition
{
	...
	unsigned char                                      UnknownData_ADH6[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableWithOffset : public FNiagaraVariableBase
{
	...
	unsigned char                                      UnknownData_5UCN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RJKY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ATG[0x68];                                    // 0x0050(0x0068) MISSED OFFSET (PADDING)
...
struct FNCPoolElement
{
	...
	unsigned char                                      UnknownData_7DXN[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FNCPool
{
	...
	unsigned char                                      UnknownData_NXUQ[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSet
{
	...
	unsigned char                                      UnknownData_QESK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OMP8[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_JZQN[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_4LEJ[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetID
{
	...
	unsigned char                                      UnknownData_ZCJA[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilityOverride : public FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_G1GN[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraDataSetCompiledData
{
	...
	unsigned char                                      UnknownData_D3X3[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_51AW[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEventGeneratorProperties
{
	...
	unsigned char                                      UnknownData_TICR[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraEventScriptProperties : public FNiagaraEmitterScriptProperties
{
	...
	unsigned char                                      UnknownData_RR26[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_94NZ[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O1UJ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FName                                       IterationSource;                                           // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_26TV[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraScriptDataInterfaceInfo
{
	...
	unsigned char                                      UnknownData_RUJP[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraSystemScalabilityOverride : public FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_XMIM[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterHandle
{
	...
	unsigned char                                      UnknownData_SPSG[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J2KJ[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraScriptDataInterfaceCompileInfo
{
	...
	unsigned char                                      UnknownData_TQ3P[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZLIE[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FVMExternalFunctionBindingInfo
{
	...
	unsigned char                                      UnknownData_GWYN[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetProperties
{
	...
	unsigned char                                      UnknownData_ZBO6[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVMExecutableData
{
	...
	unsigned char                                      UnknownData_LE8A[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SY9V[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraScriptExecutionParameterStore : public FNiagaraParameterStore
{
	...
	unsigned char                                      UnknownData_HWCW[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraGraphViewSettings
{
	...
	unsigned char                                      UnknownData_B03F[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraScalabilityManager
{
	...
	unsigned char                                      UnknownData_AB4U[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraModuleDependency
{
	...
	unsigned char                                      UnknownData_SWNO[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_R0IP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UObject*>                             RootObjects;                                               // 0x0008(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_LLJB[0x68];                                    // 0x0018(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KZ9R[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FNiagaraInputConditionMetadata
{
	...
	TArray<struct FString>                             TargetValues;                                              // 0x0008(0x0010) (Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FNiagaraVariableMetaData
{
	...
	unsigned char                                      UnknownData_A4JL[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y49F[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       ScopeName;                                                 // 0x00C0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData_4GP0[0x3];                                     // 0x00C8(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_AXBR[0x3];                                     // 0x00CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HF9E[0x2];                                     // 0x00D6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       CachedNamespacelessVariableName;                           // 0x00D8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData_K5JN[0x6];                                     // 0x00E2(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraParameterScopeInfo
{
	...
	unsigned char                                      UnknownData_HLIT[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_40ON[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVMExecutableDataId
{
	...
	unsigned char                                      UnknownData_194N[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SBCN[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneNiagaraSystemTrackImplementation : public FMovieSceneTrackImplementation
{
	...
	unsigned char                                      UnknownData_INTJ[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_D3LX[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_LRNN[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_Q3BE[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraVectorParameterSectionTemplate : public FMovieSceneNiagaraParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_DUE6[0x4];                                     // 0x02CC(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableInfo
{
	...
	struct FText                                       Definition;                                                // 0x0028(0x0018) (NativeAccessSpecifierPublic)
...
struct FNiagaraSystemUpdateContext
{
	...
	unsigned char                                      UnknownData_P8E5[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraFunctionSignature
{
	...
	unsigned char                                      UnknownData_ZM4K[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FName, struct FName>                   FunctionSpecifiers;                                        // 0x0038(0x0050) (NativeAccessSpecifierPublic)
...
{
	unsigned char                                      UnknownData_I2HD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HSNQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FNiagaraVariant
{
	...
	unsigned char                                      UnknownData_24N0[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_8ZC9[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K6UY[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
