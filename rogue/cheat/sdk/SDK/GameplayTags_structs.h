...
enum class GameplayTags_EGameplayTagEventType : uint8_t
{
...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_BUKJ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagSource
{
	...
	unsigned char                                      UnknownData_EDOK[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRestrictedGameplayTagTableRow : public FGameplayTagTableRow
{
	...
	unsigned char                                      UnknownData_BGJB[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P4S9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3J17[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8M2Y[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
