...
struct FARTraceResult
{
	...
	unsigned char                                      UnknownData_H6OL[0xB];                                     // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DLTH[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
...
struct FARSkeletonDefinition
{
	...
	unsigned char                                      UnknownData_7UFG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARPose3D
{
	...
	unsigned char                                      UnknownData_MEUO[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FARSessionStatus
{
	...
	unsigned char                                      UnknownData_LH8N[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
