...
struct FAdaptorPolygon2Group
{
	...
	unsigned char                                      UnknownData_IYRX[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
struct FAdaptorPolygon
{
	...
	unsigned char                                      UnknownData_72OK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FBOI[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMeshElementAttributeData
{
	...
	unsigned char                                      UnknownData_LVOB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolygonGroupToCreate
{
	...
	unsigned char                                      UnknownData_CQYG[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_DRWG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3MM3[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributesForEdge
{
	...
	unsigned char                                      UnknownData_0O4V[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributesForVertexInstance
{
	...
	unsigned char                                      UnknownData_SBPO[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_M4PB[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NCP1[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolygonToCreate
{
	...
	unsigned char                                      UnknownData_8QYX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KT7M[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FEdgeToCreate
{
	...
	unsigned char                                      UnknownData_UO3S[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ZLLW[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMeshElementAttributeList                   VertexInstanceAttributes;                                  // 0x0008(0x0010) (BlueprintVisible, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_MSZH[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FVertexToCreate
{
	...
	unsigned char                                      UnknownData_FCL2[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSubdividedWireEdge
{
	...
	unsigned char                                      UnknownData_1OHY[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRenderingPolygonGroup
{
	...
	int                                                MaterialIndex;                                             // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                MaxTriangles;                                              // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TMQF[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
{
	struct FPolygonGroupID                             PolygonGroupID;                                            // 0x0000(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ITNO[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
