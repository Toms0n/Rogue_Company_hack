...
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2290);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2291);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_0RQV[0x8];                                     // 0x0268(0x0008) Fix Super Size


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2292);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2293);
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NZRK[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2294);
		return ptr;
	}
	...
	class UPlayMontageCallbackProxy* STATIC_CreateProxyObjectForPlayMontage(class USkeletalMeshComponent* InSkeletalMeshComponent, class UAnimMontage* MontageToPlay, int* CreatedInstanceID, float PlayRate, float StartingPosition, const struct FName& StartingSection);
};
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(2295);
		return ptr;
	}
