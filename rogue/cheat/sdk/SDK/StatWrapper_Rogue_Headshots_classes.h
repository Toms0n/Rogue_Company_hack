...
// BlueprintGeneratedClass StatWrapper_Rogue_Headshots.StatWrapper_Rogue_Headshots_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_Headshots_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62860);
		return ptr;
	}
