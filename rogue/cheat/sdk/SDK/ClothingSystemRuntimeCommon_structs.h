...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_V7JT[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8BG3[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_ZFGA[0x20];                                    // 0x0138(0x0020) MISSED OFFSET (PADDING)
...
struct FClothParameterMask_Legacy
{
	...
	unsigned char                                      UnknownData_M54H[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2RR2[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RAY8[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
