...
{
	unsigned char                                      bEnableLookAtTracking : 1;                                 // 0x0000(0x0001) BIT_FIELD (Edit, BlueprintVisible, BlueprintReadOnly, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_MZHF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JPIE[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SFIL[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FNamedFilmbackPreset
{
	...
	unsigned char                                      UnknownData_46GB[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCameraTrackingFocusSettings
{
	...
	unsigned char                                      UnknownData_XSMW[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraFocusSettings
{
	...
	unsigned char                                      UnknownData_92OV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MJ4E[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JAWT[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5JN5[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
