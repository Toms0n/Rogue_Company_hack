...
struct FAnimationSharingScalability
{
	...
	unsigned char                                      UnknownData_TYGE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationSetup
{
	...
	unsigned char                                      UnknownData_XNZK[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationStateEntry
{
	...
	unsigned char                                      UnknownData_A8U8[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8782[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M3GI[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0DCO[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_47BN[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
