...
struct FAkMainOutputSettings
{
	...
	unsigned char                                      UnknownData_09LH[0x3];                                     // 0x0014(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_36FH[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_WVL9[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkSpatialAudioSettings
{
	...
	unsigned char                                      UnknownData_4MQB[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HC60[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_TP5L[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettingsWithSystemInitialization : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_TG9I[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_TRD7[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YW69[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VYEN[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : public FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_LWX4[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAkWindowsAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_LO7V[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_XEL1[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommonInitializationSettingsWithSampleRate : public FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_M8TD[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FAkAndroidAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_IJ8P[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfaceOverride
{
	...
	unsigned char                                      UnknownData_IKPG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkHololensAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_9MDO[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkPluginInfo
{
	...
	unsigned char                                      UnknownData_64RG[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAudioSession
{
	...
	unsigned char                                      UnknownData_6DC9[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_QMQ8[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAkPS4AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_JISL[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPS5AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint32_t                                           ACPBatchBufferSize;                                        // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_G27O[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	uint32_t                                           NumAudioOut2ObjectPorts;                                   // 0x0040(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FAkPoly
{
	...
	unsigned char                                      UnknownData_ALTO[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettingsWithCommSelection : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_H00G[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_XOQ0[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkWinGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_SVR6[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkXboxOneGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_ADZ0[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXboxOneAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_54DC[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXSXAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I4WI[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkAudioEventTrackKey
{
	...
	unsigned char                                      UnknownData_TPQD[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTangentDataSerializationHelper
{
	...
	unsigned char                                      UnknownData_OMA2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValueSerializationHelper
{
	...
	unsigned char                                      UnknownData_8L4D[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatChannelSerializationHelper
{
	...
	unsigned char                                      UnknownData_FCJ7[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_USG9[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GZMR[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YY27[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAkExternalSourceInfo
{
	...
	unsigned char                                      UnknownData_3MB9[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IXXC[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfacePropertiesToMap
{
	...
	unsigned char                                      UnknownData_R0Q1[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
