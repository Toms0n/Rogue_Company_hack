...
// BlueprintGeneratedClass StatWrapper_Rogue_DamagePerGamePlayed.StatWrapper_Rogue_DamagePerGamePlayed_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_DamagePerGamePlayed_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62867);
		return ptr;
	}
