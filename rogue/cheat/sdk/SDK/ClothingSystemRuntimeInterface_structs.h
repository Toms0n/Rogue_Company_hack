...
struct FClothCollisionPrim_Box
{
	...
	unsigned char                                      UnknownData_C99C[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothCollisionPrim_Convex
{
	...
	unsigned char                                      UnknownData_2O47[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
