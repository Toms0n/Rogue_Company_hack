...
// BlueprintGeneratedClass StatWrapper_Rogue_Damage.StatWrapper_Rogue_Damage_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_Damage_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62870);
		return ptr;
	}
