...
// BlueprintGeneratedClass StatWrapper_Rogue_Revives.StatWrapper_Rogue_Revives_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_Revives_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62853);
		return ptr;
	}
