...
struct FNavigationFilterArea
{
	...
	unsigned char                                      UnknownData_X4BU[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FNavigationFilterFlags
{
	...
	unsigned char                                      UnknownData_PSSG[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FSupportedAreaData
{
	...
	unsigned char                                      UnknownData_8ZT0[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNavGraphNode
{
	...
	unsigned char                                      UnknownData_ZREM[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WQLZ[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FNavLinkCustomInstanceData : public FActorComponentInstanceData
{
	...
	unsigned char                                      UnknownData_7M9A[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FRecastNavMeshGenerationProperties
{
	...
	unsigned char                                      UnknownData_SUH6[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CZE9[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
