...
struct FChaosCollisionEventRequestSettings
{
	...
	unsigned char                                      UnknownData_TE6Z[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosBreakingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_3S1M[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosTrailingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_KCIG[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGeomComponentCacheParameters
{
	...
	unsigned char                                      UnknownData_YIT9[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTOY[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HK7P[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7PK8[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1VFB[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CZ2A[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IU4W[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GTPG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionDebugDrawActorSelectedRigidBody
{
	...
	unsigned char                                      UnknownData_Z176[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGeometryCollectionSizeSpecificData
{
	...
	unsigned char                                      UnknownData_RY6Q[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChaosCollisionEventData
{
	...
	unsigned char                                      UnknownData_01XK[0x14];                                    // 0x0044(0x0014) MISSED OFFSET (PADDING)
