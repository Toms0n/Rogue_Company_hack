...
// BlueprintGeneratedClass StatWrapper_Player_Revives.StatWrapper_Player_Revives_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_Revives_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62880);
		return ptr;
	}
