...
struct FBTDecoratorLogic
{
	...
	unsigned char                                      UnknownData_QYLD[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlackboardKeySelector
{
	...
	unsigned char                                      UnknownData_Q768[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CV8S[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5Z64[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N1KK[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TIOP[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIDataProviderTypedValue : public FAIDataProviderValue
{
	...
	unsigned char                                      UnknownData_Z7P7[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FAIDataProviderBoolValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_Y66O[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAIDataProviderFloatValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_DNZA[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDamageEvent
{
	...
	unsigned char                                      UnknownData_40R1[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIPredictionEvent
{
	...
	unsigned char                                      UnknownData_DKSC[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_APE4[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3GK6[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAISenseAffiliationFilter
{
	...
	unsigned char                                      UnknownData_XVGB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FAIMoveRequest
{
	...
	unsigned char                                      UnknownData_ZM8X[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FBehaviorTreeTemplateInfo
{
	...
	unsigned char                                      UnknownData_FC3R[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FBlackboardEntry
{
	...
	unsigned char                                      UnknownData_4CKU[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAIDynamicParam
{
	...
	unsigned char                                      UnknownData_VXCJ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	unsigned char                                      UnknownData_3WS9[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KLO7[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
struct FIntervalCountdown
{
	...
	unsigned char                                      UnknownData_VY21[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (PADDING)
...
struct FEnvNamedValue
{
	...
	unsigned char                                      UnknownData_495G[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Value;                                                     // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FEnvTraceData
{
	...
	unsigned char                                      UnknownData_F2UG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KULQ[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDataProviderIntValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_955Z[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FEnvDirection
{
	...
	unsigned char                                      UnknownData_M8GK[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FEnvQueryInstanceCache
{
	...
	unsigned char                                      UnknownData_7O6K[0x170];                                   // 0x0008(0x0170) MISSED OFFSET (PADDING)
...
struct FEnvOverlapData
{
	...
	unsigned char                                      UnknownData_ZTIO[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YZB4[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FPawnActionEvent
{
	...
	unsigned char                                      UnknownData_FUMQ[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FAIStimulus
{
	...
	unsigned char                                      UnknownData_VB4D[0xC];                                     // 0x002C(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      UnknownData_MDQE : 1;                                      // 0x0038(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_WT0P[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9TBU[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FActorPerceptionBlueprintInfo
{
	...
	unsigned char                                      UnknownData_K314[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DBRU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnvQueryRequest
{
	...
	unsigned char                                      UnknownData_ICMU[0x50];                                    // 0x0018(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V39Y[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FKXU[0x14];                                    // 0x0018(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9ZVO[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
