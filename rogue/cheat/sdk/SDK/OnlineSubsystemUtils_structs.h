...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_JZLJ[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_HNHP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_M7BM[0x108];                                   // 0x0000(0x0108) MISSED OFFSET (PADDING)
...
struct FOnlineProxyStoreOffer
{
	...
	unsigned char                                      UnknownData_Z3W5[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BHN8[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EQS5[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductInfo2
{
	...
	unsigned char                                      UnknownData_4Z3A[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest2
{
	...
	unsigned char                                      UnknownData_8FJE[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
