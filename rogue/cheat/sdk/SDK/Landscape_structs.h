...
struct FLandscapeProxyMaterialOverride
{
	...
	unsigned char                                      UnknownData_531N[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightmapLayerAllocationInfo
{
	...
	unsigned char                                      UnknownData_8KJR[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
{
	struct FPerPlatformInt                             LODIndex;                                                  // 0x0000(0x0004) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_FIDX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UMaterialInterface*                          Material;                                                  // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData_0Z57[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MWVM[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FX9W[0x5];                                     // 0x0043(0x0005) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineConnection
{
	...
	unsigned char                                      UnknownData_GC8B[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineSegmentConnection
{
	...
	unsigned char                                      UnknownData_TULO[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FGrassInput
{
	...
	unsigned char                                      UnknownData_MPIK[0xC];                                     // 0x001C(0x000C) MISSED OFFSET (PADDING)
...
struct FLayerBlendInput
{
	...
	unsigned char                                      UnknownData_YG6S[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            LayerInput;                                                // 0x000C(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5QYM[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            HeightInput;                                               // 0x0020(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V6BQ[0x8];                                     // 0x002C(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ADE7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeLayer
{
	...
	unsigned char                                      UnknownData_GRI1[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G5CW[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_9XUW[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UZW6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XREB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GLA3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H3KY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HK15[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineMeshEntry
{
	...
	unsigned char                                      UnknownData_Q7F1[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K0AG[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K76E[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (PADDING)
