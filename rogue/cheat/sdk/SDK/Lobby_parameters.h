...
struct ALobbyBeaconClient_ServerLoginPlayer_Params
{
	...
	struct FString                                     UrlString;                                                 // 0x0038(0x0010)  (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct ALobbyBeaconClient_ServerKickPlayer_Params
{
	...
	struct FText                                       Reason;                                                    // 0x0028(0x0018)  (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
};
