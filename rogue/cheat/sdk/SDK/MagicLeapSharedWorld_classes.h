...
public:
	...
	unsigned char                                      UnknownData_ECMZ[0xA4];                                    // 0x032C(0x00A4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(702);
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(703);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_FGSA[0x18];                                    // 0x0588(0x0018) MISSED OFFSET (PADDING)
