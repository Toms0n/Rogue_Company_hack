...
struct FSynth1PatchCable
{
	...
	unsigned char                                      UnknownData_0XLN[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FEpicSynth1Patch
{
	...
	unsigned char                                      UnknownData_HBLX[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModularSynthPreset : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_7U9H[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P13X[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NBRZ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OY3V[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PGD1[0x1];                                     // 0x0057(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BF49[0x1];                                     // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7A7C[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OOFU[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OS5Q[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F25S[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W4WI[0x3];                                     // 0x00A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EGYO[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IBNF[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DEUS[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSourceEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_VLMK[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_08LA[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectEnvelopeFollowerSettings
{
	...
	unsigned char                                      UnknownData_20K2[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectEQBand
{
	...
	unsigned char                                      UnknownData_YDLK[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectFilterSettings
{
	...
	unsigned char                                      UnknownData_20OO[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	Synthesis_EStereoChannelMode                       InputMode;                                                 // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WSDE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	Synthesis_EStereoChannelMode                       OutputMode;                                                // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_MYT2[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectPhaserSettings
{
	...
	unsigned char                                      UnknownData_CLLG[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectRingModulationSettings
{
	...
	unsigned char                                      UnknownData_8CVC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Frequency;                                                 // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FSourceEffectSimpleDelaySettings
{
	...
	unsigned char                                      UnknownData_M72J[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectStereoDelaySettings
{
	...
	unsigned char                                      UnknownData_ONTU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubmixEffectConvolutionReverbSettings
{
	...
	unsigned char                                      UnknownData_5IZS[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GV18[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FSubmixEffectFilterSettings
{
	...
	unsigned char                                      UnknownData_C2GU[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTapDelayInfo
{
	...
	unsigned char                                      UnknownData_B5L6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSynth2DSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_P92V[0x4];                                     // 0x02B4(0x0004) MISSED OFFSET (PADDING)
...
struct FSynthKnobStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_6G6R[0x7];                                     // 0x0231(0x0007) MISSED OFFSET (PADDING)
...
struct FSynthSlateStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_TV7U[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
