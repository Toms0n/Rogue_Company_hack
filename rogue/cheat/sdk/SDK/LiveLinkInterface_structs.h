...
struct FLiveLinkSourceBufferManagementSettings
{
	...
	unsigned char                                      UnknownData_4S4I[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D8VM[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I132[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z1U7[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QJD9[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkSubjectPreset
{
	...
	unsigned char                                      UnknownData_GMM4[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DNOE[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P0DR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3002[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_098X[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XE5W[0x160];                                   // 0x0000(0x0160) MISSED OFFSET (PADDING)
...
struct FSubjectMetadata
{
	...
	unsigned char                                      UnknownData_O2MS[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FLiveLinkBaseFrameData
{
	...
	unsigned char                                      UnknownData_IE9X[0x20];                                    // 0x0080(0x0020) MISSED OFFSET (PADDING)
...
{
	TArray<struct FName>                               PropertyNames;                                             // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	TArray<struct FName>                               BoneNames;                                                 // 0x0010(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int>                                        BoneParents;                                               // 0x0020(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FLiveLinkCameraStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_NQG0[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_6KBU[0xB];                                     // 0x00E5(0x000B) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_5K53[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkLightStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_Q876[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_AGC4[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_4M0N[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkSourcePreset
{
	...
	struct FText                                       SourceType;                                                // 0x0018(0x0018) (NativeAccessSpecifierPublic)
...
{
	TArray<struct FName>                               BoneNames;                                                 // 0x0000(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int>                                        BoneParents;                                               // 0x0010(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FLiveLinkInterpolationSettings
{
	...
	unsigned char                                      UnknownData_GN1M[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkTransformBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_IIMR[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
