...
struct FChunkInfoData
{
	...
	unsigned char                                      UnknownData_FMQV[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G5GV[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FFileManifestData
{
	...
	unsigned char                                      UnknownData_XP7H[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NTD6[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IH5K[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
