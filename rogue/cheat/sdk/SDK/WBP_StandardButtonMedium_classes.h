...
// 0x010B (FullSize[0x0623] - InheritedSize[0x0518])
...
public:
	...
	class UAkAudioEvent*                               ClickMedBtnSFX;                                            // 0x05D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_Y94O[0x3];                                     // 0x05FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FKey                                        PromptKey;                                                 // 0x0600(0x0018) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	class UAkAudioEvent*                               HoverMedBtnSFX;                                            // 0x0618(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                               IsConfirm;                                                 // 0x0620(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	bool                                               IsCancel;                                                  // 0x0621(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	bool                                               IsRedButton;                                               // 0x0622(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62633);
		return ptr;
	}
