...
// BlueprintGeneratedClass StatWrapper_Rogue_MasteryLevel.StatWrapper_Rogue_MasteryLevel_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Rogue_MasteryLevel_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62855);
		return ptr;
	}
