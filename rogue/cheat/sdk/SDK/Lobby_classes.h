...
// 0x0088 (FullSize[0x0338] - InheritedSize[0x02B0])
...
public:
	...
	unsigned char                                      UnknownData_WTUH[0x1];                                     // 0x02C0(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	Lobby_ELobbyBeaconJoinState                        LobbyJoinServerState;                                      // 0x02C1(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_964D[0x76];                                    // 0x02C2(0x0076) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_M235[0x8];                                     // 0x0248(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      LobbyStateClass[0x28];                                     // 0x0248(0x0028) UNKNOWN PROPERTY: SoftClassProperty
...
{
public:
	struct FText                                       DisplayName;                                               // 0x0220(0x0018) (Net, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_2082[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XV16[0x48];                                    // 0x0298(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	int                                                MaxPlayers;                                                // 0x0220(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_5OG2[0x4];                                     // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KOZL[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B4G9[0x3];                                     // 0x0239(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_630S[0x68];                                    // 0x0360(0x0068) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(174);
		return ptr;
	}
