...
public:
	...
	unsigned char                                      UnknownData_WXZ0[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V7FU[0x3];                                     // 0x00E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T87Z[0x3];                                     // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(3431);
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_NJ5W[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
