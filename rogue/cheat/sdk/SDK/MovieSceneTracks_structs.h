...
struct FMovieSceneActorReferenceData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_6Q3D[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6Q5X[0x60];                                    // 0x0050(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionData
{
	...
	unsigned char                                      UnknownData_A9FD[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionData
{
	...
	unsigned char                                      UnknownData_EWYS[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XCAK[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventPtrs
{
	...
	unsigned char                                      BoundObjectProperty[0x28];                                 // 0x0008(0x0028) UNKNOWN PROPERTY: FieldPathProperty
...
{
	struct FMovieSceneEventPtrs                        Ptrs;                                                      // 0x0000(0x0030) (NativeAccessSpecifierPublic)
...
{
	unsigned char                                      UnknownData_XKTI[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventSectionData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_FOGU[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_I5M5[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	unsigned char                                      UnknownData_9Q4K[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ETJP[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VA8E[0x2];                                     // 0x00CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4E6O[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneStringChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_BQC7[0x67];                                    // 0x0039(0x0067) MISSED OFFSET (PADDING)
...
struct FMovieScene3DAttachSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_VL4R[0x2];                                     // 0x004E(0x0002) MISSED OFFSET (PADDING)
...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_J037[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWMV[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_Z3E6[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DScaleKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_J8Q4[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DRotationKeyStruct : public FMovieSceneKeyStruct
{
	...
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_J0KT[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DLocationKeyStruct : public FMovieSceneKeyStruct
{
	struct FVector                                     Location;                                                  // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AFRF[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformTemplateData
{
	...
	unsigned char                                      UnknownData_KZXN[0x3];                                     // 0x0641(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_72KF[0x7];                                     // 0x0649(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	unsigned char                                      UnknownData_N1PB[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	struct FFrameNumber                                SectionStartTime;                                          // 0x0040(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_FX2R[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraCutSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_8UDF[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PJCV[0xE];                                     // 0x0072(0x000E) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_L5FU[0x1C];                                    // 0x001C(0x001C) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_7KOB[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventTemplateBase : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_6PGF[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	struct FMovieSceneEventPtrs                        EventToTrigger;                                            // 0x0038(0x0030) (NativeAccessSpecifierPublic)
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_U9J1[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneLevelVisibilitySectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_I1J1[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneComponentMaterialSectionTemplate : public FMovieSceneParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_NRYY[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieScenePrimitiveMaterialTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_2M3H[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_LP0X[0x3];                                     // 0x02CD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_IRUI[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_RHED[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneVectorKeyStructBase : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_Z8FE[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DQIM[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorKeyStruct : public FMovieSceneVectorKeyStructBase
{
	...
	unsigned char                                      UnknownData_CT3F[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
