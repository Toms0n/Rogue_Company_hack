...
// BlueprintGeneratedClass StatWrapper_Player_DownsPerDeath.StatWrapper_Player_DownsPerDeath_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_DownsPerDeath_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62889);
		return ptr;
	}
