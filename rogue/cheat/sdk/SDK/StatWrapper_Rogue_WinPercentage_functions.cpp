...
// Function:
//		Offset -> 0x024D5B40
//		Name   -> Function StatWrapper_Rogue_WinPercentage.StatWrapper_Rogue_WinPercentage_C.GetStatValueText
...
struct FText UStatWrapper_Rogue_WinPercentage_C::GetStatValueText(class UObject* InWorldContextObject, class AKSPlayerState* InPlayerState, int DescriptorId, const struct FString& DescriptorString, bool ShouldOverwriteValue, float OverwriteValue)
{
	static UFunction* fn = UObject::GetObjectCasted<UFunction>(62847);

	UStatWrapper_Rogue_WinPercentage_C_GetStatValueText_Params params {};
...
// Function:
//		Offset -> 0x024D5B40
//		Name   -> Function StatWrapper_Rogue_WinPercentage.StatWrapper_Rogue_WinPercentage_C.GetStatValue
//		Flags  -> (Event, Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
//		class UObject*                                     InWorldContextObject                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
//		class AKSPlayerState*                              InPlayerState                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
float UStatWrapper_Rogue_WinPercentage_C::GetStatValue(class UObject* InWorldContextObject, class AKSPlayerState* InPlayerState, int DescriptorId, const struct FString& DescriptorString, bool ShouldOverwriteValue, float OverwriteValue)
{
	static UFunction* fn = UObject::GetObjectCasted<UFunction>(62846);

	UStatWrapper_Rogue_WinPercentage_C_GetStatValue_Params params {};
	params.InWorldContextObject = InWorldContextObject;
	params.InPlayerState = InPlayerState;
	params.DescriptorId = DescriptorId;
	params.DescriptorString = DescriptorString;
