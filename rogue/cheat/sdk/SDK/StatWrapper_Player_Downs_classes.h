...
// BlueprintGeneratedClass StatWrapper_Player_Downs.StatWrapper_Player_Downs_C
// 0x0000 (FullSize[0x0070] - InheritedSize[0x0070])
class UStatWrapper_Player_Downs_C : public UKSStatWrapper
{
public:
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(62892);
		return ptr;
	}
