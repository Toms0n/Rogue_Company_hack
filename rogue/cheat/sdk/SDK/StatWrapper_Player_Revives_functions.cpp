...
// Function:
//		Offset -> 0x024D5B40
//		Name   -> Function StatWrapper_Player_Revives.StatWrapper_Player_Revives_C.GetStatValueText
...
struct FText UStatWrapper_Player_Revives_C::GetStatValueText(class UObject* InWorldContextObject, class AKSPlayerState* InPlayerState, int DescriptorId, const struct FString& DescriptorString, bool ShouldOverwriteValue, float OverwriteValue)
{
	static UFunction* fn = UObject::GetObjectCasted<UFunction>(67681);

	UStatWrapper_Player_Revives_C_GetStatValueText_Params params {};
...
// Function:
//		Offset -> 0x024D5B40
//		Name   -> Function StatWrapper_Player_Revives.StatWrapper_Player_Revives_C.GetStatValue
//		Flags  -> (Event, Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
//		class UObject*                                     InWorldContextObject                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
//		class AKSPlayerState*                              InPlayerState                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
float UStatWrapper_Player_Revives_C::GetStatValue(class UObject* InWorldContextObject, class AKSPlayerState* InPlayerState, int DescriptorId, const struct FString& DescriptorString, bool ShouldOverwriteValue, float OverwriteValue)
{
	static UFunction* fn = UObject::GetObjectCasted<UFunction>(62881);

	UStatWrapper_Player_Revives_C_GetStatValue_Params params {};
	params.InWorldContextObject = InWorldContextObject;
	params.InPlayerState = InPlayerState;
	params.DescriptorId = DescriptorId;
	params.DescriptorString = DescriptorString;
