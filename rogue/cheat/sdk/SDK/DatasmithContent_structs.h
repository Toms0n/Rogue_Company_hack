...
struct FDatasmithCameraLookatTrackingSettingsTemplate
{
	...
	unsigned char                                      UnknownData_2UOW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithCameraFocusSettingsTemplate
{
	...
	unsigned char                                      UnknownData_U316[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithPostProcessSettingsTemplate
{
	...
	unsigned char                                      UnknownData_LUM8[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A5XD[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IWJT[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithTessellationOptions
{
	...
	unsigned char                                      UnknownData_B0FA[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FDatasmithImportBaseOptions
{
	...
	unsigned char                                      UnknownData_5S7Z[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithMeshBuildSettingsTemplate
{
	...
	unsigned char                                      UnknownData_VW27[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
